<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="girlHouse.aspx.cs" Inherits="mokuai_girlHouse" %>
        ...
        <tr>
            ...
            <td class="style8">
                <asp:Image ID="Image1" runat="server" Height="170px" ImageAlign="Left" 
                    Width="829px" ImageUrl="~/pictures/额.jpg" />
            </td>
        </tr>
        <tr>
            <td class="style2">
...
<br />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [ID], [Name], [PictureUrl], [Price] FROM [productInfo] WHERE (([CategoryID]%2) = @CategoryID)">
                    <SelectParameters>
