<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="shipin.aspx.cs" Inherits="mokuai_shipin" %>
        ...
        <tr>
            ...
            <td class="style8">
                <asp:Image ID="Image1" runat="server" Height="170px" ImageAlign="Left" 
                    Width="829px" ImageUrl="~/pictures/y.jpg" />
            </td>
        </tr>
        <tr>
            <td class="style2">
            ...
            <td class="style9">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="50" Name="CategoryID" Type="Int32" />
                        <asp:Parameter DefaultValue="60" Name="CategoryID2" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
