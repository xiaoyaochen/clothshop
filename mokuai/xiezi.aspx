<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="xiezi.aspx.cs" Inherits="mokuai_xiezi" %>
        ...
        <tr>
            ...
            <td class="style8">
                <asp:Image ID="Image1" runat="server" Height="170px" ImageAlign="Left" 
                    Width="829px" ImageUrl="~/pictures/买.jpg" />
            </td>
        </tr>
        <tr>
            <td class="style2">
            ...
            <td class="style9">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:Parameter DefaultValue="40" Name="CategoryID2" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
