<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="shangyi.aspx.cs" Inherits="shangyi" %>
            ...
            <tr>
                ...
                <td class="style8">
                    <asp:Image ID="Image1" runat="server" Height="170px" ImageAlign="Left" 
                        Width="829px" ImageUrl="~/pictures/背景2.jpg" />
                </td>
            </tr>
            <tr>
                <td class="style2">
...
<br />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [ID], [Name], [PictureUrl], [Price] FROM [productInfo] WHERE ([CategoryID] < @CategoryID)">
                        <SelectParameters>
