<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="taozhuang.aspx.cs" Inherits="taozhuang" %>
            ...
            <td class="style9">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:Parameter DefaultValue="30" Name="CategoryID2" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
