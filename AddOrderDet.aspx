<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddOrderDet.aspx.cs" Inherits="AddOrderDet" %>
        ...
        <td class="auto-style18">
            <asp:GridView ID="GridView1" runat="server" Width="501px" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="选购尺码" HeaderText="选购尺码" />
